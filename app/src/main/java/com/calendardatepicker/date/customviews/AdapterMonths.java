...
public class AdapterMonths extends PagerAdapter {
    ...
    public AdapterMonths(Context mContext, List<Calendar> list, CalendarStyleAttr calendarStyleAttr) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        DateMonthView dateMonthView = layout.findViewById(R.id.cvEventCalendarView);
        dateMonthView.drawCalendarForMonth(calendarStyleAttr, getCurrentMonth(modelObject), dateManager);
        dateMonthView.setCalendarListener(calendarAdapterListener);
    ...
    private DateCalendarView.CalendarListener calendarAdapterListener = new DateCalendarView.CalendarListener() {
        @Override
    ...
    public Calendar getMinSelectedDate() {
        return dateManager.getMinSelectedDate();
    }

    public Calendar getMaxSelectedDate() {
        return dateManager.getMaxSelectedDate();
    }
